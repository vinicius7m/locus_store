        ...
        <div class="col-md-5 bg-white rounded mx-auto mt-5">
            ...
            <form action="{{ route('profiles.user.update', ['user' => Auth::user()->id]) }}" method="POST" class="p-3">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input name="email" type="email" class="input-t mt-3" id="" placeholder="" value="{{ Auth::user()->email }}" required>
                    </div>

                    <label for="" class="col-sm-2 col-form-label col-form-label mt-3">Senha</label>
                    <div class="col-sm-10">
                        <input name="password" type="password" class="input-t mt-3" id="" placeholder="Insira a sua senha" required>
                    </div>

                    <label for="" class="col-sm-2 col-form-label col-form-label mt-3">Senha</label>
                    <div class="col-sm-10">
                        <input name="confPassword" type="password" class="input-t mt-3" id="" placeholder="Confirmar senha" required>
                    </div>
