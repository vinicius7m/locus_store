        <nav class="navbar navbar-expand-md navbar-light bg-light shadow-sm">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
                ...
                <form class="form-inline mx-auto my-2 mr-lg-5">
                    <div class="row">
                        <input type="text" class="form-control pr-5" name="x" placeholder=" Buscar produto...">
                        
                        <span class="input-group-btn">
                            <button class="btn rounded-right bg-orange" type="button"><i class="p-1 fa fa-search"></i></button>
                        </span>
                    </div>
                </form>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="btn bg-orange" href="{{ route('register') }}">{{ __('Cadastro') }}</a>
                    </li>
